...
<!--    </div><!-- /.row -->-->
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5 card-container">
            <div class="card">
                <div class="front">
                    <img class="featurette-image img-responsive center-block featurette-image-1" src="<?php echo get_theme_mod('featurette1_image', 'data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>" alt="Generic placeholder image">
                </div>
                <div class="back">
                    <img class="featurette-image img-responsive center-block featurette-image-1" src="<?php echo get_theme_mod('featurette1_image', 'data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>" alt="Generic placeholder image">
                </div>
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5 card-container">
            <div class="card">
                <div class="front">
                    <img class="featurette-image img-responsive center-block featurette-image-2" src="<?php echo get_theme_mod('featurette2_image', 'data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>" alt="Generic placeholder image">
                </div>
                <div class="back">
                    <img class="featurette-image img-responsive center-block featurette-image-2" src="<?php echo get_theme_mod('featurette2_image', 'data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>" alt="Generic placeholder image">
                </div>
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5 card-container">
            <div class="card">
                <div class="front">
                    <img class="featurette-image img-responsive center-block featurette-image-3" src="<?php echo get_theme_mod('featurette3_image', 'data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>" alt="Generic placeholder image">
                </div>
                <div class="back">
                    <img class="featurette-image img-responsive center-block featurette-image-3" src="<?php echo get_theme_mod('featurette3_image', 'data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>" alt="Generic placeholder image">
                </div>
